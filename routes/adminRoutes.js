...
const superAdminMiddleware = require('../middleware/auth').superAdminMiddleware;
...
router.post('/admins', superAdminMiddleware, adminController.addAdmin);
...
router.post('/settings/ip', superAdminMiddleware, adminController.updateOfficeIp);
router.post('/settings/office-time', superAdminMiddleware, adminController.updateOfficeTime);
